...
try:
    ...
    contract_sizes = {
        ...
        'FU': 10, 'BR': 5, 'RU': 5, 'SP': 10, 'OP': 20,
        # 大连商品交易所
        'Y': 10, 'P': 10, 'A': 10, 'B': 10, 'M': 10, 'C': 5, 'CS': 10, 'RR': 10,
        'JD': 10, 'L': 5, 'PP': 10, 'V': 5, 'EG': 20, 'PG': 20, 'EB': 5, 'I': 10,
        'JM': 60, 'J': 100, 'LH': 16, 'FB': 10, 'BB': 500, 'LG': 40, 'BZ': 30,
        # 郑州商品交易所
        'TA': 5, 'MA': 10, 'SA': 20, 'FG': 20, 'SR': 5, 'CF': 5, 'CY': 10,
        'OI': 10, 'RM': 10, 'RS': 10, 'UR': 20, 'SF': 5, 'SM': 5, 'PK': 5,
        'AP': 10, 'CJ': 5, 'PF': 5, 'PR': 15, 'PL': 5,
        'SC': 1000, 'LU': 10, 'NR': 10, 'BC': 5, 'EC': 50,
        # 广州期货交易所
        'SI': 5, 'LC': 3, 'PS': 1, 'PD': 1000, 'PT': 1000,
        # 中国金融期货交易所
        'TS': 100000, 'TF': 1000000, 'T': 1000000, 'TL': 1000000,
